    ...
    return BlocListener<WalletBloc, WalletState>(
      ...
      child: BlocConsumer<TradePageBloc, TradePageState>(
        ...
        builder: (context, state) {
          ...
          final wBloc = context.read<WalletBloc>();
          ...
          if (wBloc.state.chain.chainId == EthereumChain.sxMainnet.chainId) {
            if (isWeb) {
              js.context.callMethod('open', ['https://www.sharkswap.xyz/swap']);
            }
            ...
            return const Center(
              child: SizedBox(
                ...
                width: 320,
                child: Text(
                  'Redirecting to SharkSwap for trading on SX network',
